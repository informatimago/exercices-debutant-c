// -*- mode:c;coding:utf-8 -*-
//****************************************************************************
//FILE:               reverse-lines-by-byte.c
//LANGUAGE:           c
//SYSTEM:             POSIX
//USER-INTERFACE:     NONE
//DESCRIPTION
//
//    Filter inversant chaque ligne, octet par octet.
//
//AUTHORS
//    <PJB> Pascal J. Bourguignon <pjb@informatimago.com>
//MODIFICATIONS
//    2016-10-11 <PJB> Created.
//BUGS
//LEGAL
//    AGPL3
//
...
void byte_reverse(char buffer[],size_t size){
...
void reverse_one_line(char byte_buffer[],size_t byte_length,unused int lino){
    // inverse l'ordre des octets dans le byte_buffer, et ajoute un newline.
    // En entrée, le byte_buffer ne contient pas de newline;
    // en sortie, un newline est ajouté au byte_buffer.
    byte_reverse(byte_buffer,byte_length);
...
void reverse_lines(FILE* input,FILE* output){
    // Ce filtre inverse l'ordre des octets de chaque ligne.
